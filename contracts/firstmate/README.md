...
invocation, including caller-bound source/target branches, required output/exits,
forbidden flags, and the ownership split between Firstmate policy and provider
truth.
