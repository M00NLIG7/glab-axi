...
var definitions = append(issueWriteDefinitions(), append(append([]Definition{
	...
	{Path: []string{"repo", "view"}, Summary: "View a project/repository.", Usage: "gl-axi repo view [namespace/project] [--admin-snapshot] [global flags]", RepoMode: RepoOptional, MaxPositions: 1, Flags: []FlagDefinition{{Name: "--admin-snapshot", Boolean: true, Description: "Include complete edit prestate; requires explicit --repo and --hostname. Store admin_snapshot in a private file for repo edit."}}, Schema: "repo-view", Backend: "official-glab"},
