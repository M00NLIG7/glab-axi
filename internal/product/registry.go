...
var definitions = append(issueWriteDefinitions(), append(append([]Definition{
	...
	{Path: []string{"job", "view"}, Summary: "View one CI/CD job.", Usage: "gl-axi job view <id> [--pipeline-id ID] [global flags]", RepoMode: RepoRequired, Positionals: 1, MaxPositions: 1, Flags: jobIdentityFlags(), Schema: "job-view", Backend: "official-glab"},
	{Path: []string{"job", "trace"}, Summary: "View a bounded, redacted tail of one job trace.", Usage: "gl-axi job trace <id> [--pipeline-id ID] [global flags]", RepoMode: RepoRequired, Positionals: 1, MaxPositions: 1, Flags: jobIdentityFlags(), Schema: "job-trace", Backend: "official-glab"},
