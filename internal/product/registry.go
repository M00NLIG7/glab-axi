...
var definitions = append(issueWriteDefinitions(), append(append([]Definition{
	...
	{Path: []string{"issue", "view"}, Summary: "View one project issue with bounded descriptions.", Usage: "gl-axi issue view <iid> [--body-limit BYTES] [global flags]", Details: readSelectionDetails, Flags: readBodyFlags(), RepoMode: RepoRequired, Positionals: 1, MaxPositions: 1, Schema: "issue-view", Backend: "official-glab"},
	...
	{Path: []string{"mr", "view"}, Summary: "View one merge request with bounded descriptions.", Usage: "gl-axi mr view <iid> [--body-limit BYTES] [global flags]", Details: readSelectionDetails, Flags: readBodyFlags(), RepoMode: RepoRequired, Positionals: 1, MaxPositions: 1, Schema: "mr-view", Backend: "official-glab"},
