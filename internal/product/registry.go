...
var definitions = append(issueWriteDefinitions(), append(append([]Definition{
	...
	{Path: []string{"issue", "list"}, Summary: "List project issues with typed filters and bounded field selection.", Usage: "gl-axi issue list [filter/selection flags] [global flags]", Details: "Use --fields description,labels to add list fields while retaining defaults.\n" + readSelectionDetails, Flags: readListFlags(false), RepoMode: RepoRequired, Schema: "issue-list", Backend: "official-glab"},
	{Path: []string{"issue", "view"}, Summary: "View one project issue with bounded descriptions.", Usage: "gl-axi issue view <iid> [global flags]", Details: readSelectionDetails, RepoMode: RepoRequired, Positionals: 1, MaxPositions: 1, Schema: "issue-view", Backend: "official-glab"},
	...
	{Path: []string{"mr", "list"}, Summary: "List project merge requests with typed filters and bounded field selection.", Usage: "gl-axi mr list [filter/selection flags] [global flags]", Details: "Use --fields description,labels to add list fields while retaining defaults.\n" + readSelectionDetails, Flags: readListFlags(true), RepoMode: RepoRequired, Schema: "mr-list", Backend: "official-glab"},
	{Path: []string{"mr", "view"}, Summary: "View one merge request with bounded descriptions.", Usage: "gl-axi mr view <iid> [global flags]", Details: readSelectionDetails, RepoMode: RepoRequired, Positionals: 1, MaxPositions: 1, Schema: "mr-view", Backend: "official-glab"},
