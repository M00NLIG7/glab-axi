...
- Keep credentials out of argv, config, output, logs, fixtures, and source. Token-import tests construct runtime sentinels and inject an in-memory keyring. Guarded issue/MR content enters through descriptor-validated private files.
